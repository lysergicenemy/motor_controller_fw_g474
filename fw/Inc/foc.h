...
struct data_s
{
    float udRef, uqRef;                           // Input: reference D/Q-axis voltages
    ...
    float iPhaseA, iPhaseB, iPhaseC;              // Input: ABC currents
    float iAvg, iAvgFiltered, iStrtp;             // Input: Total current
    float isa, isb, isd, isq;                     // Variable: D/Q-axis currents
    float udDec, uqDec;                           // Variable: D/Q-axis voltages decoupling components
    float Te, Pe;                                 // Variable: Electrical torque and Power in watt
